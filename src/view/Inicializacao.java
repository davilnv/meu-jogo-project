...
public class Inicializacao extends TelaGenerica{
	...
	public Inicializacao() {
		...
		facilButton = new JRadioButton("Fácil", true);
		facilButton.setBounds(215, 240, 55, 20);
		medioButton = new JRadioButton("Médio", false);
		medioButton.setBounds(275, 240, 60, 20);
		dificilButton = new JRadioButton("Difícil", false);
		...
		subButton = new JRadioButton("Subtração (-)", false);
		subButton.setBounds(255, 320, 100, 20);
		multiplicaButton = new JRadioButton("Multiplicação (X)", false);
		multiplicaButton.setBounds(245, 345, 120, 20);
		divButton = new JRadioButton("Divisão (/)", false);
		...
		JPanel panel = new JPanel() {
			protected void paintComponent(Graphics g) {
				...
				g.drawString("Escolha a operação matemática:", 195, 285);
			}
		};
